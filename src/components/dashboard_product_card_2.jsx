...
const DashboardProductCard2 = () => (
    <Container className="dashboard-product-card" style={{ height: "70vh" }}>
        <Container>
        <Row>
            {/* Left Section: Product Details */}
            <Col md="3" className='side_border'>
                <CardImg
                ...
                <Link to="/admin/edit/1"><button className="btn btn-primary">Edit Product</button></Link>
            </Col>
            ...
            {/* Chart 1 */}
            <Col md="3"  className='' style={{height: "50vh"}}>
            <Card className="card-chart side_border" style={{height: "100%"}}>
                        <CardHeader>
            ...
            {/* Chart 2 */}
            <Col md="3"  className='' style={{height: "100%"}}>
            <Card className="card-chart side_border" style={{height: "100%"}}>
                        <CardHeader>
                            <h5 className="card-category">
                                Total Sold
            ...
            {/* Chart 3 */}
            <Col md="3" className=''>
                <RadarChart className="side_border" data={data} options={options}/>
            </Col>
        </Row>
        <Row>
        <Container style={{height: "10vh",width: "10vh"}}>
                <LineChart/>
        </Container>
        </Row>
        </Container>
...
export default DashboardProductCard2;
